...
![Diagram of smudge filter]({{asset:img/blog/a-case-for-git-filters/smudge.png}})<The `smudge` filter is run at checkout.>
![Diagram of clean filter]({{asset:img/blog/a-case-for-git-filters/clean.png}})<The `clean` filter is run when files are staged.>
