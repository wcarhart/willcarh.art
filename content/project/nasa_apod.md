...
![NASA APOD date picker]({{asset:img/project/nasa_apod/nasa_apod1.png}})<NASA APOD date picker interface>
...
![NASA APOD example content]({{asset:img/project/nasa_apod/nasa_apod2.png}})<Sample APoD content for a given day>